...
namespace AAXClasses
{
    ...
    public:
        ...
        public:
            ...
            {
                auto result = AAX_CHostProcessor::Initialize(iController);
...
//                jassert (getAAXProcessor().getPluginInstance().getMainBusNumInputChannels() == numOfMainInputs);
            ...
            {
                mIsFirstPass = true;
                auto start = GetSrcStart();
                auto end =   GetSrcEnd();
                
                getAAXProcessor().getPluginInstance().setRateAndBufferSizeDetails (getAAXProcessor().sampleRate, (int)(end - start));
                getAAXProcessor().getPluginInstance().prepareToAnalyse(getAAXProcessor().sampleRate, (int)(end - start), iAudioInCount);
